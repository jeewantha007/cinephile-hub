  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-3 sm:px-4 pt-20 sm:pt-24 pb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-6 sm:mb-8">Browse by Genre</h1>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2.5 sm:gap-4 mb-6 sm:mb-8">
          {genreList.map((genre) => (
            <GenreCard
              key={genre.id}
