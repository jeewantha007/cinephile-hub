...
const STATIC_ROUTES = [
  ...
  { loc: `${DOMAIN}/subtitles/english`, changefreq: "weekly", priority: "0.8" },
  { loc: `${DOMAIN}/subtitles/spanish`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/french`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/german`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/italian`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/portuguese`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/russian`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/japanese`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/korean`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/chinese`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/arabic`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/hindi`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/turkish`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/polish`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/dutch`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/swedish`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/thai`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/vietnamese`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/indonesian`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/romanian`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/czech`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/hungarian`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/greek`, changefreq: "weekly", priority: "0.7" },
  { loc: `${DOMAIN}/subtitles/finnish`, changefreq: "weekly", priority: "0.7" },
