...
const MovieCard = ({ movie }: MovieCardProps) => {
  ...
  return (
    <Link
      to={`/movie/${movie.id}`}
      className="group relative flex-shrink-0 w-[160px] sm:w-[180px] md:w-[200px] rounded-lg overflow-hidden bg-card transition-transform duration-300 hover:scale-105 hover:z-10"
    >
      {/* Poster */}
      ...
      <div className="p-2 space-y-1">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs text-primary font-semibold">{movie.vote_average.toFixed(1)}</span>
          </div>
