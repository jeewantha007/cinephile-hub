...
const DEFAULT_DESC = "CinemaHub is a movie discovery platform where users can explore trending movies, watch trailers, download subtitles in 50+ languages, and browse detailed movie information.";
