    ...
    <div className="container mx-auto px-4 py-8 sm:py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
        <div className="sm:col-span-2 md:col-span-1">
          <h3 className="text-xl font-bold mb-2 sm:mb-3">
            <span className="text-primary">Cinema</span>
            <span className="text-foreground">Hub</span>
          </h3>
          <p className="text-sm text-muted-foreground leading-relaxed">
            CinemaHub helps users discover trending movies, explore detailed movie information, download subtitles, and watch trailers using data from TMDB.
          </p>
        </div>
        <div>
          <h4 className="font-semibold text-foreground mb-2 sm:mb-3 text-sm">Navigate</h4>
        ...
        <div>
          <h4 className="font-semibold text-foreground mb-2 sm:mb-3 text-sm">Attribution</h4>
